// 0.상단 인풋태그에 대한 정의가 우선
// 1.상단 인풋태그에 대한 정의가 우선 되어야 한다
// 2.상단 인풋태그 안에 입력된 값을 찾아야한다 ("keyup 이벤트 요소를 사용")
// 3.버튼태그에 저장된 속성값을 알아야한다.
// 4.상단 인풋태그 안에 입력된 값을 찾아야 한다
// 5.인풋태그에 입력된값과 매칭되는 값을 버튼 태그의 속성값을 통해 찾는다
